...
public interface MusicConstants {
    public static final String BROADCAST_NAME = "cn.mqclient.service.broadcast";
    public static final String SERVICE_NAME = "ccn.mqclient.service.MediaService";
    public static final String BROADCAST_QUERY_COMPLETE_NAME = "cn.mqclient.service.querycomplete.broadcast";
    public static final String BROADCAST_CHANGEBG = "cn.mqclient.service.changebg";
    public static final String BROADCAST_SHAKE = "cn.mqclient.service.shake";

    //是否开启了振动模式
    public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";

    public static final String SP_NAME = "cn.mqclient.service_preference";
